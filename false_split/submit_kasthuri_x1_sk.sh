...
#SBATCH --mem=80000
#SBATCH -t 3-0:00:00
#SBATCH -o skeleton_pinky_%j.log
...
DTST=kasthuri_x1_minsz2000
SEGNAME=combined_pred_x1_malaseg_0.3.h5
PREFIX=`basename $SEGNAME .h5`
GTNAME=/n/coxfs01/paragt/test_submit/skeleton/data/gold/microns-train-gold.h5 # should the original one be used??
...
#/n/home05/paragt/NeuronComplete/build/get_skeleton -segmentation $SEGNAME stack -output_folder $SKDIR -min_region_sz 2000 -type 1 -zbuffer 15  -xybuffer 100
